...
# Raspberry Pi Pico dev environment setup script, tweaked to
# install on x86_64 Debian, Ubuntu or Mint-type platforms.
#
# Adjust JNUM and OUTDIR below to suit your setup and needs...
#
# V1.0 N. Kendrick
#
# Provided 'as is' - use at your own risk. Tested on Mint 20.1
...
OUTDIR="$(pwd)/programming/pico"

echo "Not running on a Raspberry Pi. Use at your own risk!"
read -p "Press ENTER to continue..."

# Install dependencies
# NK modified with extra deps needed...
GIT_DEPS="git"
SDK_DEPS="cmake gcc-arm-none-eabi gcc g++ libstdc++-arm-none-eabi-newlib doxygen graphviz"
...
# NK: Modified to the official way according to Microsoft...
